...
{% hint style="danger" %}
IIf you’ve already completed the Quick Start guide with the client atSign you intend on using on this machine, you can skip **Step 2**. However, be sure to complete **Steps 1, 3, and 4**.
{% endhint %}
