...
import 'package:npt_mobile_flutter/util/profile_status.dart';
...
class FavoriteProfile extends Favorite<ProfileState> {
  ...
  String resolveStatus(ProfileState state) {
    return switch (state) {
      ...
      ProfileInitial _ || ProfileLoading _ =>
        ProfileStatus.off.message, // Show as disconnected during initialization
