...
class PolicyFormView extends StatelessWidget {
  ...
  const PolicyFormView({super.key, required this.role, this.isEditing = false});
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  strings.errorWithDetails(formState.message),
  ...
  Widget _buildForm(BuildContext context) {
    return FormContent(key: ValueKey('form_${role.tempId}'));
  }
}
