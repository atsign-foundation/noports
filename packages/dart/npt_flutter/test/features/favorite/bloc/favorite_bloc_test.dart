  ...
  group('FavoriteBloc', () {
    ...
    group('clearAll', () {
      test('should emit FavoritesInitial when clearAll is called', () {
        ...
        favoriteBloc.emit(const FavoritesLoaded([testFavorite1, testFavorite2]));
    ...
    group('FavoriteLoadEvent', () {
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.getFavorites()).thenAnswer((_) async => testFavorites);
          return favoriteBloc;
        },
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.getFavorites()).thenThrow(Exception('Load failed'));
          return favoriteBloc;
        },
        act: (bloc) => bloc.add(const FavoriteLoadEvent()),
        expect: () => [
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.getFavorites()).thenAnswer((_) async => <String, Favorite>{});
          return favoriteBloc;
        },
        act: (bloc) => bloc.add(const FavoriteLoadEvent()),
        expect: () => [
    ...
    group('FavoriteAddEvent', () {
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.addFavorite(testFavorite3)).thenAnswer((_) async => true);
          return favoriteBloc;
        },
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.addFavorite(testFavorite1)).thenAnswer((_) async => true);
          return favoriteBloc;
        },
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.addFavorite(testFavorite3)).thenThrow(Exception('Add failed'));
          return favoriteBloc;
        },
        seed: () => const FavoritesLoaded([testFavorite1, testFavorite2]),
        act: (bloc) => bloc.add(const FavoriteAddEvent(testFavorite3)),
    ...
    group('FavoriteRemoveEvent', () {
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.removeFavorites([testFavorite1.uuid])).thenAnswer((_) async => true);
          return favoriteBloc;
        },
        seed: () => const FavoritesLoaded([testFavorite1, testFavorite2]),
        ...
        verify: (_) {
          verify(mockRepository.removeFavorites([testFavorite1.uuid])).called(1);
        },
      );
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.removeFavorites([testFavorite1.uuid, testFavorite2.uuid])).thenAnswer((_) async => true);
          return favoriteBloc;
        },
        seed: () => const FavoritesLoaded([testFavorite1, testFavorite2, testFavorite3]),
        act: (bloc) => bloc.add(const FavoriteRemoveEvent([testFavorite1, testFavorite2])),
        expect: () => [
          const FavoritesLoaded([testFavorite3]),
        ],
        verify: (_) {
          verify(mockRepository.removeFavorites([testFavorite1.uuid, testFavorite2.uuid])).called(1);
        },
      );
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.removeFavorites([])).thenAnswer((_) async => true);
          return favoriteBloc;
        },
        seed: () => const FavoritesLoaded([testFavorite1, testFavorite2]),
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.removeFavorites([testFavorite3.uuid])).thenAnswer((_) async => true);
          return favoriteBloc;
        },
        seed: () => const FavoritesLoaded([testFavorite1, testFavorite2]),
        act: (bloc) => bloc.add(const FavoriteRemoveEvent([testFavorite3])),
        expect: () => [], // No state change expected since favorite doesn't exist
        verify: (_) {
          verify(mockRepository.removeFavorites([testFavorite3.uuid])).called(1);
        },
      );
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        'still emits state even when repository call fails',
        build: () {
          when(mockRepository.removeFavorites([testFavorite1.uuid])).thenThrow(Exception('Remove failed'));
          return favoriteBloc;
        },
        seed: () => const FavoritesLoaded([testFavorite1, testFavorite2]),
        act: (bloc) => bloc.add(const FavoriteRemoveEvent([testFavorite1])),
    ...
    group('Repository Error Handling', () {
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.getFavorites()).thenThrow(TimeoutException('Request timeout'));
          return favoriteBloc;
        },
        act: (bloc) => bloc.add(const FavoriteLoadEvent()),
        expect: () => [
      ...
      blocTest<FavoriteBloc, FavoritesState>(
        ...
        build: () {
          when(mockRepository.getFavorites()).thenThrow(Exception('First call fails'));
          when(mockRepository.addFavorite(testFavorite1)).thenAnswer((_) async => true);
          return favoriteBloc;
        },
        act: (bloc) async {
