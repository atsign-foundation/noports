...
class AppTheme {
  ...
  static TextTheme darkTextTheme = const TextTheme(
    titleMedium: TextStyle(fontSize: 32, fontWeight: FontWeight.w600),
    titleSmall: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
    headlineLarge: TextStyle(fontSize: 22, fontWeight: FontWeight.w600),
    bodyLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
    bodyMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w600),
    ...
    return ThemeData(
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        side: WidgetStateBorderSide.resolveWith(
          (states) =>
              const BorderSide(color: AppColor.primaryColor, width: Sizes.p2),
        ),
      ),
