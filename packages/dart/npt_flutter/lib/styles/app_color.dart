...
class AppColor {
  ...
  // static const listTileColor = Color(0x70bcbcbc);
  // static const listTileTitleColorDar = Color(0xff252525);
  // static const sSHkeyManagementCardColor = Color(0xff3e3e3e);
  // static const sshManagementBarColor = Color(0xff505050);
  // static const privateGridBacgroundColor = Color(0xff3F3F3F);
  // static const inputChipBacgroundColor = Color(0XFF515151);
  // static const homeScreenGreyText = Color(0xffB7B7B7);
}
