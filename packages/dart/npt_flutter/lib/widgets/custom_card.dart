...
class CustomCard extends StatelessWidget {
  ...
  const CustomCard.dashboardContent({
    ...
    this.leftPadding = Sizes.p44,
    this.rightPadding = Sizes.p44,
    this.topPadding = Sizes.p16,
    super.key,
  }) : color = AppColor.cardColorDark,
       radiusTopLeft = const Radius.circular(Sizes.p20),
       radiusTopRight = const Radius.circular(Sizes.p20),
  ...
  const CustomCard.profile({required this.child, super.key})
    : height = null,
      width = null,
      color = Colors.white,
      ...
      topPadding = 0,
      bottomPadding = 0,
      bottomBorderSide = const BorderSide(color: AppColor.dividerColor);
  const CustomCard.profileHeader({required this.child, super.key})
    : height = null,
      width = null,
