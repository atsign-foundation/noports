...
const kProfileNameFieldValidationError =
    'Field must only use lower case alphanumeric characters and spaces';
const kPrivateKeyFieldValidationError =
    'Field must only use lower case alphanumeric characters';
