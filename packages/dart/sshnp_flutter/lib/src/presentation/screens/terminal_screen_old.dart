...
class TerminalScreenOld extends ConsumerStatefulWidget {
  const TerminalScreenOld({Key? key}) : super(key: key);

  @override
  ConsumerState<TerminalScreenOld> createState() => _TerminalScreenOldState();
}

class _TerminalScreenOldState extends ConsumerState<TerminalScreenOld> with TickerProviderStateMixin {
