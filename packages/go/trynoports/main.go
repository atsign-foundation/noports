...
This environment allows you to test out NoPorts before doing device setup.
If you're seeing this message, your client was set up correctly!
...
Combined, these will show you that there aren't any inbound ports open on this
machine. We've taken a number of precautions to ensure that we minimize the
network attack surface when you use NoPorts, while also making it as easy to
use as possible. If you're curious about how the technology works, or you want
to learn more about how we handle security, please visit our site:
