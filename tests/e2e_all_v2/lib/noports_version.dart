...
class NoPortsVersion {
  ...
  final String version; // "current", "v5.9.4", "v5.11.2", "v5.13.0", "trunk" "$commitHash"
...
bool versionIsAtLeast(NoPortsVersion versionToCheck, NoPortsVersion minimumVersion) {
  ...
  final String cleanMinimumVersion = minimumVersion.getCleanVersionString(); // e.g. '5.9.4', 'trunk', '0.0.1'
