...
void printTestResult({
  ...
  final String statusText = testResult.status == TestStatus.passed ? 'TEST PASSED' : 'TEST FAILED';
  final String color = testResult.status == TestStatus.passed ? '\x1B[32m' : '\x1B[31m'; // Green for passed, Red for failed
