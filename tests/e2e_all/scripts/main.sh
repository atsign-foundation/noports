...
function usageAndExit {
  ...
  echo "     [-u <policy versions>] - defaults to $defaultPolicyVersions (currently only d:current is used) \\"
...
defaultPolicyVersions="d:current"
...
logInfo "    policyAtSign:       $policyAtSign (currently ignored)"
